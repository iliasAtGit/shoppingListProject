...
import com.iliasAtGit.helloMVC.service.ShopDepartmentService;
import com.iliasAtGit.helloMVC.validator.ProductUserValidator;
...
public class ProductController {
	...
	@RequestMapping(value = { "/upateAjax-{id}" }, method=RequestMethod.POST, produces = "application/json; charset=utf-8")
	@ResponseBody
	public String upateAjax(@Valid @RequestBody Product product,
