...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.users">
                              ...
                              <td><ul class="list-unstyled" ng-repeat="role in u.roles">
                                    <li ng-bind="role"></li>
                                    </ul></td>
                              <td>
      ...
      <script src="<c:url value='/resources/javascript/service/user_service.js' />"></script>
      <script src="<c:url value='/resources/javascript/controller/user_controller.js' />"></script>
  </body>
</html>